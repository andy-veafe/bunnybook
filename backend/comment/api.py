...
class CommentApi:
    ...
    _notifications: CommentNotificationService = Depends(on(CommentNotificationService))
    ...
    async def get_comments(
        ...
        await self._post_api_utils.check_user_can_see_post(user, post_id)
        return await self._service.find_comments_by_post_id(post_id, older_than, limit)
