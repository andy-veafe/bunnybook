...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["chat_group_id"], ["chat_group.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["from_profile_id"], ["profile.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "privacy",
            sa.Enum("PUBLIC", "FRIENDS", name="postprivacy"),
        ...
        sa.ForeignKeyConstraint(["profile_id"], ["profile.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["wall_profile_id"], ["profile.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
