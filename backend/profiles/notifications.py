...
class NewFriend(NewNotification):
    def __init__(self, accepter_profile_id: UUID, accepter_username: str):
        super().__init__(
            event="NEW_FRIEND",
            payload={
                "profileId": accepter_profile_id,
...
class NewFriendshipRequest(NewNotification):
    def __init__(self, requester_profile_id: UUID, requester_username: str):
        super().__init__(
            ...
            payload={"byId": requester_profile_id, "byUsername": requester_username},
        )
...
class ProfilesNotificationService:
    ...
    def create_new_friend_notification(
        self, accepter_profile_id: UUID, accepter_username: str, other_profile_id: UUID
    ):
